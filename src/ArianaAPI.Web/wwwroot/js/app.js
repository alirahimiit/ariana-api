                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th class="text-left" style="width:80px;">تعداد</th>
                            <th class="text-left" style="width:110px;">قیمت واحد</th>
                            <th class="text-left" style="width:110px;">تخفیف</th>
                            <th class="text-left" style="width:110px;">مالیات</th>
                            <th class="text-left" style="width:100px;">حمل</th>
                            <th class="text-left" style="width:130px;">جمع</th>
                        </tr>
                    </thead>
                    ...
                    <tfoot>
                        <tr style="background:#EEF2FF; font-weight:700;">
                            ...
                            <td colspan="2" class="num text-left">تخفیف: ${this.fmt(detail.totalDiscount)}</td>
                            <td class="num text-left">مالیات: ${this.fmt(detail.totalTax)}</td>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th style="width:100px;">تخفیف</th>
                    <th style="width:100px;">مالیات</th>
                    <th style="width:80px;">حمل</th>
                    <th style="width:110px;">جمع</th>
                </tr>
            </thead>
            <tbody>
                ${itemsRows || '<tr><td colspan="10" class="text-center">ردیفی وجود ندارد</td></tr>'}
            </tbody>
        </table>
    `;
